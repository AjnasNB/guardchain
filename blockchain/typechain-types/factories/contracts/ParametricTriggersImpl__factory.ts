...
import type {
  ...
  ParametricTriggersImplInterface,
} from "../../contracts/ParametricTriggersImpl";
...
type ParametricTriggersImplConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ParametricTriggersImplConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ParametricTriggersImpl__factory extends ContractFactory {
  constructor(...args: ParametricTriggersImplConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): ParametricTriggersImpl__factory {
    return super.connect(runner) as ParametricTriggersImpl__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ParametricTriggersImplInterface {
    return new Interface(_abi) as ParametricTriggersImplInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ParametricTriggersImpl;
  }
}
